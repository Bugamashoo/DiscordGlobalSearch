...
# **DISCLAIMER:**
**This readme was written by an LLM based on my specific instructions. Pasting a script into a javascript console is INHERENTLY RISKY. I wrote this script as a helpful tool but you should always verify the content of scripts just in case.**
